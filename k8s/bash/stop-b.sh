...
# Stop Configs
kubectl delete -f k8s/config/central-config.yaml
kubectl delete -f k8s/config/ns-config.yaml
kubectl delete -f k8s/config/bg-config.yaml
kubectl delete -f k8s/config/nis-config.yaml
echo
